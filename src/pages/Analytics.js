            ...
            <div className="attendance-content">
                ...
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                        ...
                        <Tooltip />
                        <Legend />
                        <Line type="monotone" dataKey="lateTime" stroke="#8884d8" />
                        <Line type="monotone" dataKey="overtime" stroke="#82ca9d" />
                        <Line type="monotone" dataKey="earlyCheckOut" stroke="#ffc658" />
                    </LineChart>
                </ResponsiveContainer>
                </div>
